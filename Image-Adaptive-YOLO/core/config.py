...
parser.add_argument('--vocfog_traindata_dir', dest='vocfog_traindata_dir', default='/home/yj/Desktop/yolo/Image-Adaptive-YOLO/data/data_vocfog/train/JPEGImages/',
                    help='the dir contains ten levels synthetic foggy images')
parser.add_argument('--vocfog_valdata_dir', dest='vocfog_valdata_dir', default='/home/yj/Desktop/yolo/Image-Adaptive-YOLO/data/data_vocfog/train/JPEGImages/',
                    help='the dir contains ten levels synthetic foggy images')
...
parser.add_argument('--pre_train', dest='pre_train', default='./experiments/exp_101/checkpoint/yolov3_test_loss=5.8980.ckpt-75', help='the path of pretrained models if is not null. not used for now')
